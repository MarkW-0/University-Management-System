...
//				new User("user", "user@exampleuni.edu", "user".getBytes(StandardCharsets.UTF_8), "User", "USER")
				new Admin("admin", "admin@exampleuni.edu", "admin".getBytes(StandardCharsets.UTF_8), "Tech Administration" , "ADMIN", "ADMIN"),
				new Faculty("faculty", "faculty@exampleuni.edu", "faculty".getBytes(StandardCharsets.UTF_8), "Example Degree", "Example Interest", "Faculty Building", "Faculty", "FACULTY"),
				new Student("student", "student@exampleuni.edu", "student".getBytes(StandardCharsets.UTF_8), "000 Zero Street", "999-999-9999", "", "4", "photos/example.png",  new ArrayList<String>(), "Example Thesis Title", 92, "Example Student", "STUDENT"),
				new User("user", "user@exampleuni.edu", "user".getBytes(StandardCharsets.UTF_8), "User", "USER")
		)));
	}
}
